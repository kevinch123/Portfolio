  ...
  return (
    <section className='section' id='About'>
      <div className="container mx-auto p-12">
        ...
        <div className='flex flex-col py-5 xl:flex-row gap-24'>
          <img
            className='object-cover h-[450px] w-[320px] mt-[-50px] md:mx-auto lg:mx-0 rounded-2xl'
            src={FotoA}
